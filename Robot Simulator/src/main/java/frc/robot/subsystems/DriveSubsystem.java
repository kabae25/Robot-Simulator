...
public class DriveSubsystem extends SubsystemBase {
  ...
  VictorSPXSimCollection leftMotor1Sim = leftMotor1.getSimCollection();
  VictorSPXSimCollection leftMotor2Sim = leftMotor2.getSimCollection();
  VictorSPXSimCollection rightMotor1Sim = rightMotor1.getSimCollection();
  VictorSPXSimCollection rightMotor2Sim = rightMotor2.getSimCollection();
